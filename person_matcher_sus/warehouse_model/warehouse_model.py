...
# ---- sivep-gripe
from lente_ist.warehouse_model.data_models import Pessoa, SinanAidsAdultoInfo, SinanAidsCriancaInfo, SiclomInfo, PairsLabel
...
class WarehouseIST:
    ...
    def __init__(self, engine_url):
        ...
        self._imported_data_models = [ Pessoa(self._metadata).define(),
                                       ...
                                       PairsLabel(self._metadata).define() ]
